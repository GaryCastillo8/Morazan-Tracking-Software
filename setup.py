...
description = 'Satellite tracker for MrzSat'
version = '1.0'
...
def write_desktop_file():
    ...
    icon = 'Icon={}/.local/lib/{}/site-packages/MTS/img/favicon1.png'.format(home, python_ver)
    with open('{}/MTS.desktop'.format(here), 'w') as f:
        f.write('[Desktop Entry]\n')
        f.write('Type=Application\n')
        f.write('Name=Morazán Tracking Software\n')
        f.write('Version={}\n'.format(version))
        f.write('GenericName=MTS\n')
        f.write('Comment={}\n'.format(description))
        f.write('Terminal=false\n')
        f.write('Categories=Application;Science;DataVisualization;Engineering\n')
        f.write('StartupNotify=true\n')
        f.write('Exec={}/.local/bin/MTS\n'.format(home))
        f.write(icon)
    return [('share/applications', ['MTS.desktop'])]
...
setup(
    ...
    name='Morazán Tracking Software',  # Required
    ...
    # project.
    author='Morazán Proyect',  # Optional

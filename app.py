...
#from pypredict import polar_diagram
...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    __slots__ = ["Sats", "img", "mainSat", "mainSat_lats",
                 ...
                 "canvas","canvas2", "saa", "date", "db", "en_db", "time_timer",
                 "sats_timer", "canvas_timer", "bg_timer", "Dialog",
                 "table_timer", "axp", "sats_lngs", "sats_lats", "usr_sats",
    ...
    def __init__(self, Sats):
        ...
        self.setWindowIcon(QtGui.QIcon("{}favicon1.png".format(self.img_path)))
        self.setWindowTitle('Morazán Tracking Software')
        self.dmin = 0
        self.forward = False
        self.backward = False
        self.pause = False
        ...
        #self.fig.canvas2.mpl_connect('scroll_event',self.zoom)
        self.run()
    ...
    """   
    def plotP(self):
        self.fig1 = figure(figsize=(16, 8))
        self.ax1 = self.fig1.add_axes([0, 0, 1, 1], projection=PlateCarree(),
                                    frameon=False)
        img_extent = (-180, 180, -90, 90)
        self.map1 = self.ax1.imshow(self.polar_diagram(),
                                  origin='upper', extent=img_extent,
                                  transform=PlateCarree())
    """  
    ...
    def gridAndFormat(self, gcolor, galpha, tcolor, tsize):
        ...
        self.ax.plot(-87,14, marker="o", color="red")
        self.ax.text(-87, 14.5, "Cabañas", color=tcolor, size=tsize,
                     transform=PlateCarree(), va="center")
    ...
    def data_gen(self):
        ...
        self.ax_tray, = self.ax.plot([], [], color='green',
                                     ...
                                     transform=Geodetic())
        self.ax_sat, = self.ax.plot([], [], 'yo', ms=7)
        self.sats_lngs = []
        self.sats_lats = []
        self.readAllSats()
    ...
    def setCanvas2(self):
        ...
        self.ui.frame_plot3.layout().addWidget(self.canvas2)
    """    
    ...
    def updateTableContent(self):
        ...
        """
        tab_index = self.ui.tabWidget.currentIndex()
        if (self.ui.tabWidget.tabText(tab_index) == "Orbital Parameters"):
            rad2deg = 180/pi

...
class Sat(Node):
    __slots__ = ["cat", "incl", "RAAN0", "RAAN", "e", "w0", "w", "MA0", "MA",
                 ...
                 "line1", "line2", "tlepath"]
    def __init__(self, name="Long March 5", line1="1 48275U 21035B   21128.16721749  .04372387  78711-5  25110-3 0  9993", line2="2 48275  41.4664 164.4624 0054573 240.7188 185.5749 16.33856982  1432", tlepath=None, cat="Rocketbody"):
        """
        Parameters
        ----------
        name    : str, optional
